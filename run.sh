...
python3 main.py --expName "action_only_finetuned" --train --epochs 5 --netLength 6 --gpus 0 --workers 1 --taskSize
8 --batchSize 64 --weightsToKeep 20 --earlyStopping 2 --restoreEpoch 11 --incluAction --actionOnlyTrain
@configs/args1.txt --trainedNum 1000 --testedNum 1000
